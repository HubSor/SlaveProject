...
#define UE_PROJECT_NAME SlaveProjectUE
#define UE_TARGET_NAME SlaveProjectUEEditor
#define UE_MODULE_NAME "SlaveProjectUE"
...
#define SLAVEPROJECTUE_API DLLEXPORT
